    ...
    public partial class AddMissingTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DropForeignKey(
                name: "FK_OrderItems_SaleBooks_SaleBookId",
                table: "OrderItems");
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "Id",
                keyValue: 1,
                columns: new[] { "Category", "Title", "Year" },
                values: new object[] { "Klassika", "O'tkan kunlar", 1925 });
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Klassika", true });

            migrationBuilder.CreateIndex(
                name: "IX_SaleBooks_Category",
                table: "SaleBooks",
                column: "Category");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 1,
                columns: new[] { "Category", "Title", "Year" },
                values: new object[] { "Roman", "O'tgan kunlar", 1922 });
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Category", "IsAvailable" },
                values: new object[] { "Roman", false });

            migrationBuilder.InsertData(
                table: "Books",
                columns: new[] { "Id", "Author", "Category", "CreatedAt", "IsAvailable", "Title", "UpdatedAt", "Year" },
                values: new object[] { 3, "Tohir Malik", "Roman", new DateTime(2024, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, "Shaytanat", null, 1996 });
